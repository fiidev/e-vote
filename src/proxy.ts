 ...
 *    - Akses /verify dengan session aktif → redirect ke /vote.
 *    - Akses /vote tanpa session → redirect ke /verify.
 * Menjadikan halaman /verify murni statis (SSG) sehingga aman di-cache Cloudflare Edge CDN.
 */
